<template>
  <div class="ask-page">
    <el-form :inline="true" ref="form">
      ...
      <div class="row disp">
        <el-input class="userInput" cols="10" rows="2"  type="textarea"  placeholder="Input text" v-model="inText" style="width: 500px">
        </el-input>
        <el-button class="askBtn" :loading="askClicked" @click="ask">Ask</el-button>
      </div>
...
export default {
    ...
    methods: {
      ...
      async submitFile() {
        ...
        await axios.post(r_const.queryUpload,
                        formData,
                        { params: {fname: names}},
      ...
      async ask() {
        ...
        this.outText = ' ';
        const response = await axios.get(r_const.queryAsk,  {params:{text: this.inText}});
        this.resSeqs = [];
