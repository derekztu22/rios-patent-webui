  ...
  <div class="collect-page">
    <el-form :inline="true" ref="form">
      <el-form-item>
        ...
        <el-button class="addcol_btn" @click="addColumn">Add New Country</el-button>
      </el-form-item>
      <el-form-item>
        <el-button class="delrow_btn" @click="delRow">Delete Text Row</el-button>
        <el-button class="delcol_btn" @click="delCol">Delete Country</el-button>
      </el-form-item>
    </el-form>
    <div class="table-container">
        <table class="main-table" cellspacing="0">
          <tr>
            <td><textarea style="width: 100%; height: 100%; border: none">Language 1</textarea></td>
            <td><textarea style="width: 100%; height: 100%; border: none">Language 2</textarea></td>
          </tr>
        </table>
    </div>
    <el-form>
    ...
    methods: {
      async save() {
        ...
        for (let i = 0; i < table.rows[0].cells.length; i++) {
            header.push(table.rows[0].cells[i].getElementsByTagName("textarea")[0].value);
        }
        for (let i = 1; i < table.rows.length; i++) {
            var row = {};
            for (var j = 0; j < table.rows[i].cells.length; j++) {
                row[header[j]] = table.rows[i].cells[j].getElementsByTagName("textarea")[0].value;
            }
            rows.push(row);
        }
