<template>
  <div class="translator-page">
    <el-form :inline="true">
      <div>
        ...
        <el-form-item>
          <el-button
            ...
            @click="loginExec"
            id="loginBtn">Login</el-button>

          <el-button
            type="primary"
            :loading="logout_clicked"
            @click="logoutExec"
            id="logoutBtn">Logout</el-button>
        </el-form-item>
      </div>

      Source Language
      <el-form-item>
        <el-select v-model="in_lang" style="width:120px">
          <el-option
      ...
      Target Language
      <el-form-item>
        <el-select v-model="out_lang" style="width:120px">
          <el-option
            v-for="item in languages"
            :key="item.value"
            :label="item.value"
      ...
      <el-form-item>
        ...
        <el-button
          ...
          @click="retrain"
          id="retrainBtn">Retrain</el-button>
    ...
    <el-form :inline="true">
      <el-form-item>
        <el-button
          ...
          @click="translate"
          id="translateBtn">Translate</el-button>
      </el-form-item>
    </el-form>
    <br />
    <br />
    ...
    <div class="container">
      ...
      <div class="form-group row mb-0">
        <div class="col-md-6 offset-md-4">
          <el-button
            type="primary"
            :loading="submit_clicked"
            @click="submit"
            id="submitButton">Submit</el-button>
          <el-button
            type="primary"
            :loading="submit_clicked"
            @click="showTranslatedDocx"
            id="showTranslatedButton">Show Translated Docx</el-button>
        </div>
      </div>
    </div>
    ...
    <div class="modal" v-if="showTranslated">
      <div class="showDoc-content" ref="docRef">
        ...
        <div class="modal-footer">
          <button class="close-button" @click="closeTranslatedDocx">
            Close
          </button>
        </div>
      </div>
        ...
        <div class="modal-footer">
          ...
          <div class="custom-file">
            <input
              type="file"
              class="custom-file-input"
              id="customKeywordFile"
              ref="xlsxFile"
              @change="handleXLSXObject()"/>
          </div>
          <button
            @click.prevent="keywordUpload"
            type="keywordUpload"
  ...
  methods: {
    ...
    async saveExec() {
      try {
        ...
        await axios.get(
          r_const.querySaveModel,
          {
            params: { path: this.save_path, cookie: 'sessionid=' + this.user },
          },
          { withCredentials: true }
        )
    ...
    async loadExec() {
      try {
        ...
        await axios.get(
          r_const.queryLoadModel,
          {
            params: { path: this.load_path, cookie: 'sessionid=' + this.user },
          },
          { withCredentials: true }
        )
